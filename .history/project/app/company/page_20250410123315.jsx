...
const Company = () => {
  ...
  <div className="flex flex-col xl:flex-row xl:pt-4 divide-y xl:divide-y-0 xl:divide-x divide-dotted">
    <div className="xl:w-1/3 flex flex-col justify-between py-2 xl:py-0 px-0 xl:px-4">
      <div className="text-gray-600 text-sm font-medium">Company type</div>
      <div className="text-base">IT Product</div>
    </div>

    <div className="xl:w-1/3 flex flex-col justify-between py-2 xl:py-0 px-0 xl:px-4">
      <div className="text-gray-600 text-sm font-medium">Company industry</div>
    ...
    <div className="xl:w-1/3 flex flex-col justify-between py-2 xl:py-0 px-0 xl:px-4">
      <div className="text-gray-600 text-sm font-medium">Company size</div>
  ...
  <div className="flex flex-col xl:flex-row xl:pt-4 divide-y xl:divide-y-0 xl:divide-x divide-dotted">
    <div className="xl:w-1/3 flex flex-col justify-between py-2 xl:py-0 px-0 xl:px-4">
      ...
      <div className="flex items-center">
        <svg className="hidden">
          <symbol id="us-flag" viewBox="0 0 512 512">
            <!-- flag paths... -->
          </symbol>
        </svg>
    ...
    <div className="xl:w-1/3 flex flex-col justify-between py-2 xl:py-0 px-0 xl:px-4">
      <div className="text-gray-600 text-sm font-medium">Working days</div>
      <div className="text-base">Monday - Friday</div>
    </div>

    <div className="xl:w-1/3 flex flex-col justify-between py-2 xl:py-0 px-0 xl:px-4">
      <div className="text-gray-600 text-sm font-medium">Overtime policy</div>
