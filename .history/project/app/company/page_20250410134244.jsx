...
const Company = () => {
  return (
    <div className="h-auto w-full">
      ...
      <div className="bg-white shadow-md rounded-xl mb-5 sticky top-0 justify-center items-center z-10 p-10 mt-2">
        <ul className="flex justify-center gap-8 px-5 justify-center items-center">
