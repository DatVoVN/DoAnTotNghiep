...
const Company = () => {
  return (
    <div className="h-auto w-full">
      ...
      <div className="bg-white shadow-md rounded-xl mb-5 sticky top-0 z-10  p-10 mt-2">
        <ul className="flex justify-around xl:justify-start gap-8 xl:gap-12 px-5 xl:px-6 justify-center items-center">
