...
const Company = () => {
  return (
    <div className="h-auto w-full">
      ...
      <div
        class="bg-it-white box-shadow-medium border-radius-large-xl imb-5 tabs-sticky"
        data-employers--scroll-target="tabs"
      >
        <ul class="itabs justify-content-around justify-content-xl-start igap-8 igap-xl-12 ipx-5 ipx-xl-6">
          <li class="item">
            <a
          ...
          <li class="item">
            ...
            >
              Reviews
              <div class="badge-counter ims-2">17</div>
            </a>
          </li>
          <li class="item">
            <a
