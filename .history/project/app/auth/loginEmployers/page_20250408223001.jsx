...
const LoginEmployers = () => {
  return (
    <div className="bg-[#f6f6f6] pt-20 min-h-screen">
      <div class="flex items-center h-16 justify-between box-border px-4 fixed w-full !bg-neutral-4 text-neutral-84 top-0 left-0 none-login-header z-50 bg-amber-50"></div>
