...
const HeroSectionEmployer = () => {
  return (
    <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-red-900 text-white min-h-screen">
      <div className="container mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24 grid lg:grid-cols-2 gap-8 lg:gap-16 items-center h-full">
        ...
        <div className="relative mt-12 lg:mt-0 h-full flex items-center justify-center">
