    ...
    <div>
      <div className="max-w-3xl mx-auto p-6">
        ...
        <p className="text-lg text-gray-700 mb-4">
          ...
          công nghệ niêm yết trên sàn chứng khoán Tokyo. Với môi trường linh
          hoạt, nhân viên được hỗ trợ để phát triển bản thân một cách toàn diện
          và cân bằng giữa công việc và cuộc sống cá nhân.
        </p>
      ...
      <div>
        <p className="p-5 font-bold">BLOG OTHER</p>
        <BlogIT />
      </div>
    </div>
  );
