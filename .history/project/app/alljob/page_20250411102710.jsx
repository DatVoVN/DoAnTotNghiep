...
const page = () => {
  return (
    <div className="max-w-screen-xl mx-auto px-4 mt-3">
      ...
      <div className="bg-white p-4 rounded-xl border border-[#EFEFF0] shadow-none lg:shadow mb-6 mt-6">
              ...
              >
                ...
                >
                  <a href="https://vieclam24h.vn/" itemProp="item">
                    <span itemProp="name" className="text-gray-500">
                      Trang chủ
                    </span>
                  </a>
                ...
                <li className="text-gray-400 truncate" aria-current="page">
                  Tuyển dụng 18,060 việc làm mới nhất năm 2025
                </li>
              </ol>
            </nav>
          </div>
          <div className="relative text-xl lg:text-2xl lg:leading-10 -mt-3 px-0 !mb-0 mb-4 w-full lg:w-full mx-auto">
