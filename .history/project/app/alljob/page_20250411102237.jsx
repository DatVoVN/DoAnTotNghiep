...
const page = () => {
  return (
    <div className="max-w-screen-xl mx-auto px-4 mt-3">
      ...
      <div class="bg-white p-4 rounded-xl border border-[#EFEFF0] shadow-none lg:shadow mb-6">
  <div class="flex flex-col justify-between -mt-4">
    <div class="hidden md:block relative w-full mx-auto">
      <nav class="py-4">
        <ol class="flex items-center capitalize text-xs" itemscope itemtype="https://schema.org/BreadcrumbList">
          <li class="flex items-center min-w-max" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="https://vieclam24h.vn/" itemprop="item">
              <span itemprop="name" class="text-gray-500">Trang chủ</span>
            </a>
            <meta itemprop="position" content="1" />
            <span class="text-gray-400 px-1">/</span>
          </li>

          <li class="flex items-center sr-only" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="https://vieclam24h.vn/tim-kiem-viec-lam-nhanh" itemprop="item">
              <span itemprop="name" class="text-gray-500">Tìm kiếm việc làm</span>
            </a>
    ...
    <div class="relative text-xl lg:text-2xl lg:leading-10 -mt-3 px-0 !mb-0 mb-4 w-full lg:w-full mx-auto">
      <div class="flex items-center gap-4">
        <h1>
          Tuyển dụng <strong>18,060</strong> việc làm mới nhất năm <strong>2025</strong>
        </h1>
      </div>
    </div>
