...
export default function Developer() {
  return (
    <>
      ...
      <Tool />
      <p className="text-center text-3xl font-extrabold text-blue-600 tracking-wide underline decoration-blue-300 decoration-2 underline-offset-4 mt-10 mb-2">
        COMPANY
      </p>

      <div className="grid grid-cols-4 p-2 justify-items-center items-center">
        <Company />
        <Company />
        <Company />
      </div>
