...
export default function SearchBar() {
  ...
  return (
    <div className="flex flex-col p-2 text-[#414042] bg-white border border-[#dedede] gap-2 shadow-[0px_8px_24px_0px_#a09fc652] bg-gradient-to-b from-[rgba(208,208,208,0.33)] via-[rgba(255,255,255,0.5)] to-white rounded-2xl">
      {/* Thanh tìm kiếm */}
