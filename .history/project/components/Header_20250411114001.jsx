...
const Header = () => {
  ...
  // Note: You mentioned `/employer` in your initial problem description,
  // but the code here uses `/developer`. I've kept `/developer` based on the code provided.
  // Change href="/developer" to href="/employer" if that's the correct path.
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-blue-700 text-white py-4 px-6 space-y-3">
          ...
          <button
            ...
            className="block text-sm font-medium hover:underline w-full text-left" // Added w-full text-left for button feel
          >
            Đăng ký / Đăng nhập
          </button>
          {/* Use Link for the employer section */}
          <Link
            href={employerPath}
            target="_blank" // Keep consistent with desktop
            rel="noopener noreferrer"
