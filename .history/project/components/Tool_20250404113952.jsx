    ...
    <div className="w-full h-[300px] bg-white flex flex-col pb-4">
      ...
      <div className="flex space-x-4 p-1 h-[80%]">
        <div className="w-1/3 p-5 h-full bg-white border border-gray-300 shadow-lg rounded-lg text-center">
          ...
          <button className="bg-black rounded text-white p-2">UPDATE CV</button>
        </div>
        <div className="w-1/3 p-5 h-full bg-white border border-gray-300 shadow-lg rounded-lg text-center">
          ...
          <button className="bg-black rounded text-white p-2">CREATE CV</button>
        </div>
        <div className="w-1/3 p-5 h-full bg-white border border-gray-300 shadow-lg rounded-lg text-center">
          ...
          <button className="bg-black rounded text-white p-2">BLOG</button>
        </div>
      </div>
    </div>
  );
