...
const Tool = () => {
  return (
    <div className="w-full h-[500px] bg-white flex flex-col pb-4 p-3">
      <p className="text-center text-3xl my-6 font-extrabold text-blue-600 tracking-wide underline decoration-blue-300 decoration-2 underline-offset-4">
        BEST TOOL
      </p>
      ...
      <div className="flex space-x-4 p-1 h-[90%]">
        <div className="w-1/3 p-5 h-full bg-white border border-gray-300 shadow-lg rounded-lg text-center flex flex-col items-center">
          ...
          <button className="bg-blue-500 rounded text-white p-2 mt-auto w-[70%] hover:bg-gray-800 transition">
            UPDATE CV
          </button>
        </div>
