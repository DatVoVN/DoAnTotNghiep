  ...
  return (
    <div className="w-full h-[500px] bg-white flex flex-col pb-4 p-3">
      ...
      <div className="flex space-x-4 p-1 h-[90%]">
        <div className="w-1/3 p-5 h-full bg-white border border-gray-300 shadow-lg rounded-lg text-center flex flex-col justify-between">
          <div>
            ...
            <button className="bg-black rounded text-white p-2 w-[70%]">
              UPDATE CV
            </button>
          </div>
