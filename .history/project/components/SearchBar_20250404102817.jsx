...
export default function SearchBar() {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      {/* Search Bar */}
      <div className="flex items-center p-2 text-[#414042] bg-white border border-[#dedede] rounded h-20 gap-2 shadow-[0px_8px_24px_0px_#a09fc652] bg-gradient-to-b from-[rgba(208,208,208,0.33)] via-[rgba(255,255,255,0.5)] to-white w-full max-w-4xl">
        {/* Location Selector */}
      ...
      <div className="flex flex-wrap items-center gap-3">
        <span className="text-white font-semibold">Suggestions for you:</span>
