    ...
    <div className="flex flex-col xl:flex-row items-center xl:items-start gap-4 w-full">
      ...
      <div className="w-32 h-32 border rounded-lg shadow-md flex-shrink-0 order-xl-0">
        <a href="/nha-tuyen-dung/shbfinance" target="_blank" rel="nofollow">
          <img
            src="https://itviec.com/rails/active_storage/representations/proxy/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaDdCem9MWm05eWJXRjBTU0lJYW5CbkJqb0dSVlE2RW5KbGMybDZaVjkwYjE5bWFYUmJCMmtCcWpBPSIsImV4cCI6bnVsbCwicHVyIjoidmFyaWF0aW9uIn19--89a7283b6fdfb4208cdc2b440a36613a6fae974c/shb-finance-logo.jpg"
            alt="SHBFinance Logo"
