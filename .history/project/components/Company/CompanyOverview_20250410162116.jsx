...
const CompanyOverview = () => {
  return (
    <div className="flex flex-col bg-yellow-50 rounded-2xl xl:flex-row items-center xl:items-start justify-center gap-4 w-[95%] mx-auto">
      ...
      <div className="border-t xl:border-none pt-4  xl:pl-6 order-xl-1 w-full flex flex-col justify-center">
        <a
          href="/nha-tuyen-dung/shbfinance"
          target="_blank"
          rel="nofollow"
      ...
      <div className="flex justify-between w-full xl:w-auto gap-6 order-xl-2 items-center">
        <div className="text-center flex-1 justify-center flex">
