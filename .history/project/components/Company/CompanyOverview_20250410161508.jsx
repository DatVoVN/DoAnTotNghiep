...
const CompanyOverview = () => {
  return (
    <div className="flex flex-col bg-yellow-50 rounded-2xl xl:flex-row items-center xl:items-start justify-center gap-4 w-[95%] mx-auto">
      <div className="w-32 h-32 shadow-md border rounded-lg flex-shrink-0 order-xl-0">
      ...
      <div className="flex items-center bg-yellow-50 rounded-2xl p-4 w-[95%] mx-auto">
        {/* Cột 1: Hình ảnh */}
        ...
        <div className="flex flex-col justify-center px-6 w-full">
          <a
            ...
            target="_blank"
            rel="nofollow"
            className="text-xl font-semibold text-black hover:text-red-600 mb-2"
          >
            SHBFinance
          </a>
          ...
          <div className="text-sm text-gray-600">
            “ Môi trường làm việc thoải mái, Sếp vui tính, không chậm lương.
            Mình làm việc ở đây được trên 1 năm, đánh giá chung là môi trường
            rất HAPPY.”
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center text-center px-4">
          ...
          <div className="text-sm">Đánh giá chung</div>
          <a href="#" className="text-sm text-blue-600">
            Xem chi tiết
          </a>
          <div className="mt-2 text-xl font-bold">100%</div>
