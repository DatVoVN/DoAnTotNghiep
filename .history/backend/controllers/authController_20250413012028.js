  ...
  registerCandidate: async (req, res) => {
    try {
      ...
      if (!emailSent) {
        ...
        return res
          .status(500)
          .json({ message: "Lỗi gửi email xác thực. Vui lòng thử lại." });
      }
      ...
      res.status(200).json({
        // Trả về 200 thay vì 201 vì cần bước xác thực
        message:
          "Đăng ký gần thành công! Vui lòng kiểm tra email và nhập mã OTP để hoàn tất.",
...
// TODO: Thêm controller resendOtp nếu cần
};
